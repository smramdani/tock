...
class BotAdminServiceTest {
    ...
    inner class SingleExistingStoryTest {
        ...
        inner class ExistingBuiltinStoryTest {
            ...
            @Test
            fun `GIVEN builtin story exists WHEN saving the same story THEN replace the story`() {

                val theNewStory = aBuiltinStory.copy(name = "otherName")

                BotAdminService.saveStory(existingStory.namespace, theNewStory, "testUser")

                verify(exactly = 1) { storyDefinitionDAO.delete(existingStory) }
            ...
            @Test
            fun `GIVEN builtin story exists WHEN saving the same story with different _id THEN replace the story`() {
        ...
        inner class ExistingConfiguredStoryTest {
            ...
            @Test
            fun `GIVEN configured story exists WHEN saving the same story THEN replace the story`() {
    ...
    inner class BothExistingStoriesTest {
        ...
        inner class SaveBuiltinStoryTest {
            ...
            @Test
            fun `GIVEN builtin and configured story exist WHEN saving the same builtin story THEN replace the builtin story`() {

                val theNewStory = aBuiltinStory.copy(name = "otherName")

                BotAdminService.saveStory(theNewStory.namespace, theNewStory, "testUser")

                verify(exactly = 1) { storyDefinitionDAO.delete(existingBuiltinStory) }
            ...
            @Test
            fun `GIVEN builtin and configured story exist WHEN saving the same builtin story with different _id THEN replace the builtin story`() {
